    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: '#FAFAFA' }}>
        <div className="text-center">
          ...
          <p style={{ color: '#717171', fontFamily: 'Onest, sans-serif' }}>Loading Owner Portal...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-7xl mx-auto px-16 py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-8">
              ...
              <span style={{ color: '#0D0C22', fontSize: '16px', fontWeight: 500 }}>Owner Portal</span>
            </div>
          ...
          <>
            <div className="mb-12 grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-xl p-8" style={{ border: '1px solid #E8E8E8', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
                ...
                <p style={{ fontSize: '36px', fontWeight: 600, color: '#8B5CF6' }}>
                ...
                <table className="min-w-full">
                  <thead style={{ background: '#FAFAFA' }}>
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left" style={{ fontSize: '12px', fontWeight: 600, color: '#717171' }}>PROPERTY</th>
                  ...
                  {finances.propertyBreakdown.length === 0 ? (
                    ...
                    <table className="min-w-full">
                      ...
                      <tbody className="bg-white">
                        {finances.propertyBreakdown.map((breakdown, index) => (
                          <tr key={breakdown.propertyId} style={{ borderTop: index === 0 ? 'none' : '1px solid #E8E8E8' }}>
                            ...
                            <td className="px-8 py-5 whitespace-nowrap text-right" style={{ fontSize: '14px', color: '#3B82F6' }}>
                              AED {breakdown.paid.toLocaleString()}
                            </td>
                            <td className="px-8 py-5 whitespace-nowrap text-right" style={{ fontSize: '14px', color: '#EF4444' }}>
                              AED {breakdown.expenses.toLocaleString()}
                            </td>
                            <td className="px-8 py-5 whitespace-nowrap text-right" style={{ fontSize: '14px', fontWeight: 600, color: '#0D0C22' }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {properties.map((property) => (
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center" style={{ fontSize: '14px', marginBottom: '12px' }}>
                      ...
                      <div className="flex justify-between items-center" style={{ paddingTop: '12px', borderTop: '1px solid #E8E8E8' }}>
                        ...
                        <span
                          ...
                          style={{
                            fontSize: '11px',
                            fontWeight: 500,
                            background: property.is_active ? '#D1FAE5' : '#F3F4F6',
                            color: property.is_active ? '#065F46' : '#6B7280'
                          }}
                        >
