...
import { ArrowLeft, Edit, Trash2, Clock, User, Building, Sparkles, FileText, MessageSquare, CheckCircle, XCircle, Calendar, Plus, X, ChevronDown } from 'lucide-react'
          ...
          <div className="w-80 flex-shrink-0 space-y-4">
            ...
            <CleaningChecklist 
              ...
              onChecklistChange={(items) => {
                ...
                // Here you can save the checklist to the backend if needed
              }}
            />
                  ...
                  <div className="space-y-4">
                    ...
                    <select
                      ...
                      onChange={(e) => setTask(prev => ({ ...prev, unit: e.target.value }))}
                                className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm min-w-[200px] appearance-none bg-white pr-10"
                    >
                    ...
                    <select
                      ...
                      onChange={(e) => setTask(prev => ({ ...prev, type: e.target.value }))}
                                className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm min-w-[160px] appearance-none bg-white pr-10"
                    >
                  ...
                  <div className="space-y-4">
                    ...
                    <select
                      ...
                      onChange={(e) => setTask(prev => ({ ...prev, cleaner: e.target.value }))}
                                className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm min-w-[180px] appearance-none bg-white pr-10"
                    >
                    ...
                    <select
                      ...
                      onChange={(e) => setTask(prev => ({ ...prev, duration: e.target.value }))}
                                className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm min-w-[140px] appearance-none bg-white pr-10"
                    >
                    ...
                    <select
                      ...
                      onChange={(e) => setTask(prev => ({ ...prev, priority: e.target.value }))}
                                className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm min-w-[120px] appearance-none bg-white pr-10"
                    >
                        ...
                        <div className="space-y-3">
                          {task.notes.split('\n\n').map((note, index) => {
                            ...
                            if (timestampMatch) {
                              ...
                              return (
                                <div key={index} className="bg-slate-50 rounded-lg p-4 border border-slate-200 hover:bg-slate-100 transition-colors group">
                                      ...
                                      <button
                                        onClick={() => {
                                          ...
                                          if (newContent !== null && newContent.trim() !== content) {
                                            const updatedNote = `[${timestamp}] ${author}: ${newContent.trim()}`
                                            const updatedNotes = task.notes.split('\n\n')
                                            updatedNotes[index] = updatedNote
                                            handleSaveField('notes', updatedNotes.join('\n\n'))
                                          }
                                        }}
                                        className="text-orange-600 hover:text-orange-700 cursor-pointer"
                                        title="Edit note"
                              ...
                              return (
                                <div key={index} className="bg-slate-50 rounded-lg p-4 border border-slate-200 hover:bg-slate-100 transition-colors group">
                                  <div className="flex items-center justify-between mb-2">
                                    <span className="text-xs text-gray-500">Legacy note</span>
                                    <div className="flex items-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                      <button
                                        onClick={() => {
                                          const newContent = prompt('Edit note:', note)
                                          if (newContent !== null && newContent.trim() !== note) {
                                            const updatedNotes = task.notes.split('\n\n')
                                            updatedNotes[index] = newContent.trim()
                                            handleSaveField('notes', updatedNotes.join('\n\n'))
                                          }
                                        }}
                                        className="text-orange-600 hover:text-orange-700 cursor-pointer"
