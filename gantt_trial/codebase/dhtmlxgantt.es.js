...
dhtmlxGantt v.9.0.15 Professional Evaluation
...
function Qe(t) {
  t._get_linked_task = function(o, l) {
    var d = null, c = l ? o.target : o.source;
  ...
  t._isLinksCacheEnabled = function() {
    ...
    var c = [], u = this._get_link_target(o), h = this._get_link_source(o);
    if (!h || !u || t.isSummaryTask(u) && t.isChildOf(h.id, u.id) || t.isSummaryTask(h) && t.isChildOf(u.id, h.id)) return c;
    ...
    d || (d = { start_date: u.start_date, end_date: u.end_date }, this.isSummaryTask(u) && !s(u) && ((d = this.getSubtaskDates(u.id)).start_date = d.end_date, this.eachTask(function(S) {
    ...
    for (var v = this._getImplicitLinks(o, u, function(S) {
      return !f || _ || S.$target.length || t.getState("tasksDnd").drag_id == S.id ? 0 : t.calculateDuration({ start_date: d.start_date, end_date: S.start_date, task: u });
      ...
      t._linkedTasks[$.target] = t._linkedTasks[$.target] || {}, t._linkedTasks[$.target][$.source] = !0, c.push(t._convertToFinishToStartLink(w.task, $, h, u, m.taskParent, w.taskParent));
    }
    return n && (e[o.id] = c), c;
      ...
      for (var f in this.eachTask(function(k) {
        ...
        if (t._isAutoSchedulable(y)) {
          ...
          for (var b = 0; b < v.length && o.type != t.config.links.start_to_start && o.type != t.config.links.start_to_finish; b++) {
            var g = t.getLink(v[b]), m = c ? g.target : g.source, p = _[m];
          ...
          if (!h) {
            ...
            let w = 0;
            k && (w = d(y)), u.push({ task: y.id, taskParent: y.parent, lag: w, subtaskLink: !0 });
          }
        }
      }
    ...
    return this.isTaskExists(o.id) && this.eachParent(function(h) {
      var _;
      c || (n && (d = l ? i : a)[h.id] ? u = u.concat(d[h.id]) : this.isSummaryTask(h) && (this._isAutoSchedulable(h) ? (_ = this._getDirectDependencies(h, l), n && (d[h.id] = _), u = u.concat(_)) : c = !0));
    }, o.id, this), u;
    ...
    return d = l ? u : u.concat(this._getInheritedPredecessors(o)), n && (r[c] = d), d;
    ...
    switch (String(l.type)) {
      ...
      case String(t.config.links.start_to_finish):
        f = -d.duration - c.duration, _.sourceLag = -d.duration, _.targetLag = -c.duration;
        break;
      default:
        f = 0;
    }
...
function nn() {
  return { getVertices: function(t) {
    ...
    for (var e = {}, i = [], a = this.groupAdjacentEdges(n), r = !1, s = [], o = 0; o < t.length; o++) {
      var l = y(t[o]);
      if (!l.visited) for (var d = [l], c = 0; d.length; ) {
        var u = d.pop();
        u.visited || (u.index = c, u.lowLink = c, c++, i.push(u), u.onStack = !0, u.visited = !0), r = !1, n = a[u.id] || [];
        ...
        if (!r) {
          ...
          d.length && (_ = u, (u = d[d.length - 1]).lowLink = Math.min(u.lowLink, _.lowLink));
        }
      }
    }
    return s;
...
class je {
  ...
  resolveRelationDate(n, e, i) {
    ...
    for (let _ = 0; _ < d.length; _++) {
      ...
      this._comparator.isGreaterOrDefault(c, y, l) && (c = y), this._comparator.isGreaterOrDefault(o, v, l) && this._comparator.isGreaterOrDefault(a, y, l) && (a = y, s = v, r = f.id);
    }
    ...
    const h = Pt.Create(u);
    return h.link = r, h.task = n, h.end_date = a, h.start_date = s, h.kind = "alap", c && (h.latestSchedulingStart = this._gantt.calculateEndDate({ start_date: c, duration: -l.duration, task: l }), h.latestSchedulingEnd = c), h;
  }
...
class Fe {
  ...
  resolveRelationDate(n, e, i) {
    ...
    const o = this._gantt.getTask(n), l = e.predecessors, d = {};
    let c = null;
    for (let f = 0; f < l.length; f++) {
      const y = l[f];
      s = y.preferredStart;
      const v = this.getEarliestStartDate(y, i, o);
      if (this._comparator.isSmallerOrDefault(c, v, o) && (c = v), this._comparator.isSmallerOrDefault(s, v, o) && this._comparator.isSmallerOrDefault(a, v, o) && (a = v, r = y.id), !o.duration) {
    ...
    return _.link = r, _.task = n, _.start_date = a, _.end_date = u, _.kind = "asap", c && (_.earliestSchedulingStart = c, _.earliestSchedulingEnd = this._gantt.calculateEndDate({ start_date: c, duration: o.duration, task: o })), _;
  }
...
class ri {
  ...
  generatePlan(n, e) {
    const i = this._graphHelper, a = this._gantt, r = this._constraintsHelper, s = this._alapStrategy, o = this._asapStrategy, { orderedIds: l, reversedIds: d, relationsMap: c, plansHash: u } = this.buildWorkCollections(n, e, i);
    let h;
    return this.processConstraints(l, u, a, r), h = a.config.schedule_from_end ? this.iterateTasks(d, l, r.isAlapTask, s, o, c, u) : this.iterateTasks(l, d, r.isAsapTask, o, s, c, u), h;
  }
  applyProjectPlan(n) {
    const e = this._gantt;
    let i, a, r, s;
  ...
  summaryLagChanged(n, e, i) {
    ...
    for (const o in a) {
      ...
      const d = n.getTask(o), c = n.calculateDuration({ start_date: d.start_date, end_date: d.end_date, task: d }), u = n.calculateDuration({ start_date: l.min, end_date: l.max, task: d });
      u !== c && (d.start_date = l.min, d.end_date = l.max, d.duration = u);
    }
    for (const o in r) {
      const l = r[o];
      let d, c;
      const u = a[l.source], h = a[l.target];
      u && (d = { start_date: u.start_date, end_date: u.end_date }), h && (d = { start_date: h.start_date, end_date: h.end_date }), n._formatLink(l, d, c).forEach(function(_) {
...
function he(t, n, e) {
  ...
  for (; i.length > 0; ) if (o = i.shift(), !e[o]) {
    ...
    for (let c = 0; c < n.length; c++) {
      const u = n[c];
      u.source == o || u.sourceParent == o ? (e[u.target] || (i.push(u.target), s[u.id] = !0, n.splice(c, 1), c--), r[u.hashSum] = u) : u.target != o && u.targetParent != o || (e[u.source] || (i.push(u.source), s[u.id] = !0, n.splice(c, 1), c--), r[u.hashSum] = u);
    }
  }
  const l = [];
  let d = [];
  ...
  constructor(n, e) {
    this.getConnectedGroupRelations = (i) => he(i, this._linksBuilder.getLinkedTasks(), {}).processedLinks, this.getConnectedGroup = (i) => {
      ...
      return function(r) {
        const s = {}, o = [];
        let l, d, c;
        for (let u = 0; u < r.length; u++) if (l = r[u].source, d = r[u].target, c = null, s[l] ? s[d] || (c = d) : c = l, c) {
          const h = r.length;
          o.push(he(c, r, s)), h !== r.length && (u = -1);
        }
        return o;
...
function li(t, n, e, i) {
  const a = function() {
    ...
    }), t.attachEvent("onBeforeLinkAdd", d), t.attachEvent("onBeforeLinkAdd", c), t.attachEvent("onBeforeLinkUpdate", d), t.attachEvent("onBeforeLinkUpdate", c), t.attachEvent("onBeforeTaskDrag", function(x, $, S) {
...
function K(t) {
  ...
  if (t.getBoundingClientRect) {
    ...
    n = r.top + l - c, e = r.left + d - u, i = document.body.offsetWidth - r.right, a = document.body.offsetHeight - r.bottom;
  } else {
...
class pi {
  constructor(n) {
    this.show = (e, i) => {
      ...
      i._waiAria.quickInfoHeader(r, [e.header.title, e.header.date].join(" ")), o.innerHTML = e.header.title, l.innerHTML = e.header.date, e.header.title || e.header.date ? s.style.display = "" : s.style.display = "none", d.innerHTML = e.content;
      const u = e.buttons;
  ...
  _show_quick_info(n, e) {
    ...
    if (i.config.quick_info_detached) {
      ...
      const s = a.offsetWidth, o = a.offsetHeight, l = i.getScrollState(), d = r.xViewport, c = r.yViewport, u = d.offsetWidth + l.x - s, h = n.top - l.y + o;
      let _ = n.top;
...
const On = Object.freeze(Object.defineProperty({ __proto__: null, bind: z, copy: X, defined: G, event: Rn, eventRemove: Hn, mixin: O, uid: ut }, Symbol.toStringTag, { value: "Module" }));
function Ve(t, n) {
  t = t || Rn, n = n || Hn;
...
class vi {
  ...
  _calculateTooltipPosition(n) {
    const e = this._gantt, i = this._getViewPortSize(), a = this.getNode(), r = { top: 0, left: 0, width: a.offsetWidth, height: a.offsetHeight, bottom: 0, right: 0 }, s = e.config.tooltip_offset_x, o = e.config.tooltip_offset_y, l = document.body, d = dt(n, l), c = K(l);
...
class ki {
  ...
  attach(n) {
    ...
    let a = null;
    const r = (s) => {
      const o = At(s), l = ct(o, n.selector);
...
class yi {
  ...
  _attachEvents() {
    ...
    r.attachEvent("onBeforeItemMove", (l, d, c) => (this.isMoveEventsIgnored() || i(), !0)), r.attachEvent("onAfterItemMove", (l, d, c) => (this.isMoveEventsIgnored() || this.onTaskMoved(a(l)), !0)), e.attachEvent("onRowDragStart", (l, d, c) => (this.toggleIgnoreMoveEvents(!0), i(), !0));
    let s = null, o = !1;
    if (e.attachEvent("onBeforeTaskDrag", (l) => {
      ...
      e.attachEvent("onGanttLayoutReady", () => {
        ...
        }), l = e.ext.inlineEditors.attachEvent("onBeforeEditStart", (c) => (this.stopBatchAction(), !0));
      });
    }
  }
  _storeCommand(n) {
  ...
  _applyAction(n) {
    ...
    s[i.task] = { add: "addTask", get: "getTask", update: "updateTask", remove: "deleteTask", move: "moveTask", isExists: "isTaskExists" }, s[i.link] = { add: "addLink", get: "getLink", update: "updateLink", remove: "deleteLink", isExists: "isLinkExists" }, r.batchUpdate(function() {
      for (let o = 0; o < n.commands.length; o++) {
        e = n.commands[o];
        const l = s[e.entity][e.type], d = s[e.entity].get, c = s[e.entity].isExists;
...
const $i = { auto_scheduling: function(t) {
  Ze(t), Qe(t);
  var n = an(t), e = nn(), i = ze.Create(t), a = new ri(t, e, i), r = new si(t, n), s = new oi(t, e, n);
  ...
  t.attachEvent("onParse", function() {
    ...
    if (t.callEvent("onBeforeAutoSchedule", [l]) !== !1) {
      ...
      var c = i.getConstraints(l, t.isTaskExists(l) ? d : null), u = [], h = e.findLoops(d);
    ...
    var c;
    d = d === void 0 || !!d, c = l !== void 0 ? t.config.auto_scheduling_compatibility ? n.getLinkedTasks(l, d) : r.getConnectedGroupRelations(l) : n.getLinkedTasks(), t._autoSchedule(l, c);
  ...
  function e() {
    ...
    const r = t.$ui.getView("timeline"), s = new gi(i, t, r);
  ...
  Ze(t), Qe(t);
  var n = function(i) {
    var a = an(i), r = nn(), s = { _freeSlack: {}, _totalSlack: {}, _slackNeedCalculate: !0, _linkedTasksById: {}, _successorsByTaskId: {}, _projectEnd: null, _calculateSlacks: function() {
      ...
      if (l.length) {
        ...
        for (var c = 0; c < o.length; c++) o[c].hashSum in d && (o.splice(c, 1), c--);
      }
      ...
      for (var u = {}, h = i.getTaskByTime(), _ = 0; _ < l.length; _++) {
        ...
        if (this._isCompletedTask(y)) u[y.id] = 0;
          ...
          for (var f = 0; f < v.length; f++) {
            ...
            let p = 0;
            u[m.id] !== void 0 && (p += u[m.id]), p += c.getDist(y, m), p -= g.link.lag || 0, b = b === null ? p : Math.min(b, p);
          }
          u[y.id] = b || 0;
  ...
  t.config.highlight_critical_path = !1, e.init(n), t.isCriticalTask = function(i) {
    ...
    if (s[0]) for (l = 0; l < s.length; l++) {
      var d = this.getLink(s[l]), c = this._getSlack(i, a, this._convertToFinishToStartLink(d.id, d, i, a, i.parent, a.parent));
      (r > c || l === 0) && (r = c);
    }
  ...
  t.ext || (t.ext = {}), t.ext.quickInfo = new pi(t), t.config.quickinfo_buttons = ["icon_edit", "icon_delete"], t.config.quick_info_detached = !0, t.config.show_quick_info = !0, t.templates.quick_info_title = function(a, r, s) {
  ...
  t.config.undo = !0, t.config.redo = !0, t.config.undo_types = { link: "link", task: "task" }, t.config.undo_actions = { update: "update", remove: "remove", add: "add", move: "move" }, t.ext || (t.ext = {}), t.ext.undo = { undo: () => n.undo(), redo: () => n.redo(), getUndoStack: () => n.getUndoStack(), setUndoStack: (c) => n.setUndoStack(c), getRedoStack: () => n.getRedoStack(), setRedoStack: (c) => n.setRedoStack(c), clearUndoStack: () => n.clearUndoStack(), clearRedoStack: () => n.clearRedoStack(), saveState: (c, u) => e.store(c, u, !0), getInitialState: (c, u) => u === t.config.undo_types.link ? e.getInitialLink(c) : e.getInitialTask(c) }, t.undo = t.ext.undo.undo, t.redo = t.ext.undo.redo, t.getUndoStack = t.ext.undo.getUndoStack, t.getRedoStack = t.ext.undo.getRedoStack, t.clearUndoStack = t.ext.undo.clearUndoStack, t.clearRedoStack = t.ext.undo.clearRedoStack, t.attachEvent("onTaskIdChange", (c, u) => {
    const h = n;
  ...
  function n(l, d, c) {
    ...
    if (c[0].resource_id || (c = [{ resource_id: c, value: 8 }]), typeof l == "string" && (l = l.split(",")), l.length == 1) return c[0].resource_id = l[0], [c[0]];
    const u = [];
    l.length > 1 && (l = [...new Set(l)]);
    for (let h = 0; h < l.length; h++) {
      let _ = l[h], f = c.map(function(y) {
  ...
  t._groups = { relation_property: null, relation_id_property: "$group_id", group_id: null, group_text: null, loading: !1, loaded: 0, dynamicGroups: !1, set_relation_value: void 0, _searchCache: null, init: function(l) {
    ...
    if (!this.loading && u !== void 0) {
      ...
      l.isTaskExists(_) && _ != d.id && (h = this._searchCache[u]), this._groups_pull[u] = h;
    }
    return h;
  }, clear: function() {
    ...
    for (var c = [], u = 0; u < l.length; u++) {
      var h = t.copy(l[u]);
      h.type = d, h.open === void 0 && (h.open = !0), h.$virtual = !0, h.readonly = !0, h[this.relation_id_property] = h[this.group_id], h.text = h[this.group_text], c.push(h);
    }
    return c;
  }, clear_temp_tasks: function(l) {
    for (var d = 0; d < l.length; d++) l[d].$virtual && (l.splice(d, 1), d--);
  }, generate_data: function(l, d) {
    var c = l.getLinks(), u = l.getTaskByTime();
    ...
    this.clear(), this.relation_property = l, this.group_id = d, this.group_text = c;
    ...
    this._groups.regroup = function() {
      ...
      }), d._groups.group_tasks(d, g, h, _, f), !0;
  ...
  t.config.multiselect = !0, t.config.multiselect_one_level = !1, t._multiselect = { _selected: {}, _one_level: !1, _active: !0, _first_selected_when_shift: null, getDefaultSelected: function() {
    ...
    var i = this.getSelected(), a = this.getFirstSelected(), r = !1, s = this.getLastSelected(), o = t.config.multiselect, l = (function() {
      ...
      if (s) {
        if (e) {
          var c = t.getGlobalTaskIndex(this.getFirstSelected()), u = t.getGlobalTaskIndex(e), h = t.getGlobalTaskIndex(s);
          c != -1 && h != -1 || (c = u, this.reset());
          for (var _ = s; t.getGlobalTaskIndex(_) !== c; ) this.unselect(_, n), _ = c > h ? t.getNext(_) : t.getPrev(_);
          for (_ = e; t.getGlobalTaskIndex(_) !== c; ) this.select(_, n) && !r && (r = !0, a = _), _ = c > u ? t.getNext(_) : t.getPrev(_);
        }
      } else s = e;
    }).bind(this);
  ...
  t.attachEvent("onBeforeGanttRender", function() {
    ...
    return l = l || t.uid(), n[l] = function(d, c) {
      var u = document.createElement("div");
      return u.setAttribute("data-overlay-id", d), u.className = "gantt_overlay", u.style.display = "none", { id: d, render: c, isVisible: !1, isAttached: !1, node: u };
    }(l, o), l;
  ...
  return t.ext = t.ext || {}, t.ext.export_api = t.ext.export_api || { _apiUrl: "https://export.dhtmlx.com/gantt", _preparePDFConfigRaw(n, e) {
      ...
      if (i) {
        ...
        for (let s = 0; s < e.data.length; s++) {
          ...
          for (let l = 0; l < r.length; l++) {
            const d = i(o, r[l]);
            d && e.data[s].styles.push({ index: l, styles: t.ext.export_api._getStyles(d) });
          }
        }
      }
    }
    ...
    for (let d = 0; d < o.length; d++) {
      ...
      l[u.id] && t.ext.export_api._onCircDependencyFind(c, e, a, r), l[u.id] = !0, t.ext.export_api._clearCircDependencies(u, e, i, a, r, c);
    }
    a[n.id] = !1;
...
function wi(t) {
  ...
  var i = { init: function() {
    ...
    var s = ln;
    return e() && (s = dn), s.date_to_str(a, r, t);
  }, str_to_date: function(a, r) {
    var s = ln;
    return e() && (s = dn), s.str_to_date(a, r, t);
...
var Ue = function(t) {
  ...
  return this._attachDataChange(function() {
    ...
    var c = r[l.id];
    return s && (c && i[l.id] && !e[l.id] && (c = !!d), i[l.id] && !e[l.id] && (l.$split_subtask = !0)), l.$expanded_branch = !!r[l.id], !!c;
...
Ue.prototype = O({ _buildTree: function(t) {
  ...
  if (!gt(t, e)) {
    ...
    for (var l = [], d = 0; d < o.length; d++) Gt(o[d], null, this, this._ganttConfig) && (l.push(o[d]), o.splice(d, 1), d--);
    this._replace_branch_child(s, t);
    var c = (o = this.getChildren(e))[n];
    (c = lt(c, a)) ? o = o.slice(0, n).concat([t]).concat(o.slice(n)) : o.push(t), l.length && (o = o.concat(l)), gt(r.$rendered_parent, s) || gt(s, e) || (r.$rendered_parent = s), this.setParent(r, e), this._branches[e] = o;
...
${o}`), a = s.subscales || [];
    ...
    for (var c = this.splitSize(s, i.length), u = r, h = [], _ = i.length - 1; _ >= 0; _--) {
      ...
      f && this.processIgnores(y), this.initColSizes(y, a, u, c[_]), this.limitVisibleRange(y), f && (u = y.full_width), h.unshift(y);
    }
    ...
    for (var d = i.ignore_x || {}, c = 0; c < i.trace_x.length; c++) if (d[i.trace_x[c].valueOf()] || i.display_count == i.count) i.width[c] = 0;
      ...
      var u = 1;
      i.unit == "month" && (u = Math.round((n.add(i.trace_x[c], i.step, i.unit) - i.trace_x[c]) / 864e5)), i.width[c] = u;
    }
    ...
    for (var l = a.trace_x, d = i.trace_x, c = r || 0, u = s || d.length - 1, h = 0, _ = 1; _ < l.length; _++) {
      ...
      f !== void 0 && f <= u && (o && o.apply(this, [h, _, c, f]), c = f, h = _);
    }
    ...
    for (+c >= +d && (d = n.add(c, a, i)); +c < +d; ) {
      ...
      c = n.add(c, a, i), c = t._correct_dst_change(c, u, a, i), n[i + "_start"] && (c = n[i + "_start"](c));
    }
    ...
    var l = a.length - 1, d = a[l], c = n.add(d, i.step, i.unit);
...
function Mi(t) {
  var n = function(c) {
    var u = new jn(c).primaryScale(), h = u.unit, _ = u.step;
    if (c.config.scale_offset_minimal) {
      var f = new Fn(c), y = [f.primaryScale()].concat(f.getSubScales());
  ...
  if (!a.start_date || !a.end_date) {
    ...
    a.start_date && a.end_date || (a = { start_date: /* @__PURE__ */ new Date(), end_date: /* @__PURE__ */ new Date() }), t.eachTask(function(c) {
      t.config.deadlines && c.deadline && pe(a, c.deadline, c.deadline), c.constraint_date && c.constraint_type && t.config.constraint_types && c.constraint_type !== t.config.constraint_types.ASAP && c.constraint_type !== t.config.constraint_types.ALAP && pe(a, c.constraint_date, c.constraint_date), t.config.baselines && c.baselines && c.baselines.forEach(function(u) {
...
function Pi(t) {
  ...
  return t.$services.getService("state").registerProvider("batchUpdate", function() {
    ...
    if (e) o(l);
      ...
      e = !1, d || this.render(), u && (this._dp.setUpdateMode(c), this._dp.setGanttMode("task"), this._dp.sendData(), this._dp.setGanttMode("link"), this._dp.sendData());
    }
  };
}
function Ri(t) {
    ...
    const r = { renderEditableLabel: function(s, o, l, d, c) {
      ...
      a.attachEvent("onGanttReady", function() {
        ...
        a.event(a.$container, "keypress", function(d) {
          ...
          d.key === "Tab" && (s = Ut(a.$container).indexOf(document.activeElement));
...
function zi(t) {
  ...
  var e = "auto", i = "singleValue", a = "valueArray", r = "resourceValueArray", s = "assignmentsArray", o = e, l = "fixedDates", d = "fixedDuration", c = "default";
  function u(p, k) {
    ...
    if (p.mode = p.mode || c, p.mode === d && (isNaN(Number(p.duration)) && (k = k || t.getTask(p.task_id), p.duration = t.calculateDuration({ start_date: p.start_date, end_date: p.end_date, id: k })), x && (k = k || t.getTask(p.task_id), p.delay = t.calculateDuration({ start_date: k.start_date, end_date: p.start_date, id: k }))), p.mode !== l && (k || t.isTaskExists(p.task_id))) {
...
function ji(t) {
  ...
  t.config.types.placeholder = "placeholder", t.attachEvent("onDataProcessorReady", n(function(o) {
    o && !o._silencedPlaceholder && (o._silencedPlaceholder = !0, o.attachEvent("onBeforeUpdate", n(function(l, d, c) {
  ...
  constructor(n = null) {
    this.canParse = (e) => {
      ...
      for (let c = 0; c < o.length; c++) {
        const u = o[c], h = this._getValueFromMinutes(s, u, c === d);
        s -= this._getValueInMinutes(h, u), l += `${this._getLabelForConvert(h, u, r)}${c === d ? "" : " "}`;
      }
      return l;
    }, this.parse = (e) => {
      if (this.canParse(e)) {
        ...
        for (let d = 0; d < e.length; d++) {
          const c = e[d];
          l.test(c) ? r = a : a = !0, (r || o === d) && (r || (i += c), s += this._getNumericValue(i), a = r = !1, i = ""), i += c;
        }
        if (s) {
...
const Ge = function(t, n) {
  ...
  let l = o.maxHeight, d = e.height, c = d > i, u = e.rowHeight >= i && !o.splitChild && !s;
  (c || u) && (d = i), l < d && (d = l);
  let h = Math.floor((e.rowHeight - d) / 2);
  if (o.splitChild && (h = Math.floor((l - d) / 2)), r || s) {
    let _ = Math.min(e.height, l) - d, f = 2, y = s && a.bar_height >= a.row_height, v = o.splitChild && e.height >= l;
...
class qi {
  ...
  findColumnsIndexes() {
    ...
    for (let f = d; u(f, c) && (i === void 0 || a === void 0); f = h(f)) e[f].hide || (o.startX = o.endX, o.endX += e[f].width, _ >= o.startX && (_ <= o.endX || !u(h(f), c)) && (i = f, r = o.startX, s = o.endX, l = (_ - o.startX) / (o.endX - o.startX)), n === e[f].name && (a = f));
...
var ue = function(t, n, e, i) {
  this.$config = O({}, n || {}), this.$gantt = i, this.$parent = t, _t(this), this.$state = {}, O(this, Un(this));
};
function Yi(t) {
  function n(e) {
...
ue.prototype = { init: function(t) {
  ...
  var l = function(c, u) {
    var h = { column_before_start: c.bind(function(_, f, y) {
    ...
    }, c), column_after_start: c.bind(function(_, f, y) {
    ...
    }, c), column_drag_move: c.bind(function(_, f, y) {
      ...
      if (w < x && (w = x), v.keep_grid_width) {
        ...
        var D = w, A = c.$container.offsetWidth, I = 0;
    ...
    }, c), column_drag_end: c.bind(function(_, f, y) {
      ...
      if (p.max_width && p.max_width < w && (w = p.max_width), u.callEvent("onColumnResizeEnd", [m, p, w]) !== !1 && p.width != w) {
        ...
        u.callEvent("onColumnResizeComplete", [b, u._setColumnsWidth(g, m)]), u.$config.scrollable || c.$layout._syncCellSizes(u.$config.group, { value: v.grid_width, isGravity: !1 }), this.render();
      }
    }, c) };
    return { init: function() {
      var _ = c.$services.getService("dnd"), f = u.$getConfig(), y = new _(u.$grid_scale, { updates_per_second: 60 });
      ...
      for (var _ = u.getGridColumns(), f = u.$getConfig(), y = 0, v = u.$config.width, b = f.scale_height, g = 0; g < _.length; g++) {
        ...
        if (y += p.width, m = f.rtl ? v - y : y, p.resize && g != _.length - 1) {
          ...
          k.className = "gantt_grid_column_resize_wrap", k.style.top = "0px", k.style.height = b + "px", k.innerHTML = "<div class='gantt_grid_column_resize'></div>", k.setAttribute(f.grid_resizer_column_attribute, g), k.setAttribute("column_index", g), c._waiAria.gridSeparatorAttr(k), u.$grid_scale.appendChild(k), k.style.left = Math.max(0, m) + "px";
        }
      }
    } };
  }(n, this);
  ...
  if (t.autofit || i.length) {
    ...
    if (t.autofit && !t.grid_elastic_columns) for (r = 0; r < a.length; r++) {
      ...
      a[r] += d, (c = this._getColumnWidth(n[r], t, a[r])) != a[r] && (d = c - a[r], a[r] = c), l -= d;
    }
...
class Qi {
  ...
  getEndDate(n, e, i, a, r) {
    ...
    if (s.endDates[l] === void 0) {
      ...
      s.endDates[l] = u, s.durations[this._durationCacheKey(o, u)] = e, d = c;
...
Pe.prototype = { units: ["year", "month", "week", "day", "hour", "minute"], _clearCaches: function() {
  ...
  for (var _ = !1; r.valueOf() < s.valueOf(); ) {
    if (_ = (c = this._nextDate(r, e, i)).valueOf() > s.valueOf(), this._isWorkTime(r, e)) (u || h && _) && (o = a[e + "_start"](new Date(r)), l = a.add(o, i, e)), u ? (u = !1, c = this._nextDate(o, e, i), d += (l.valueOf() - r.valueOf()) / (l.valueOf() - o.valueOf())) : h && _ ? (h = !1, d += (s.valueOf() - r.valueOf()) / (l.valueOf() - o.valueOf())) : d++;
    else {
  ...
  var l = this.$gantt.date.day_start(new Date(r)), d = r, c = this._getMinutesBetweenSingleDay(s, o, e, i) / 60, u = this._getMinutesBetweenSingleDay(l, d, e, i) / 60, h = c + this._getWorkUnitsForRange(o, l, e, i) + u;
  return Math.round(h);
}, getConfig: function() {
  ...
  for (var s = 0, o = [], l = 0, d = this._isMinutePrecision(i); a < n; ) {
    ...
    if (o.length && l) if (o[0].start >= h && u >= l) {
      ...
      if (_) if (h === f.start && u >= f.durationMinutes) a += f.durationMinutes, i = this.$gantt.date.add(i, f.durationMinutes, "minute");
        ...
        v <= u ? (a += v, i = d ? this.$gantt.date.add(i, v, "minute") : this._nextDate(i, "hour", e)) : (a += (r = this._addMinutesUntilHourEnd(i, u)).added, i = r.end);
      }
...
function na(t) {
  ...
  function a(s, o, l, d) {
    ...
    let h;
    h = s.type === t.config.types.project && s.auto_scheduling === !1 ? u : c, o.$no_start && (s[h.start] = l ? new Date(l) : n(s, this.getParent(s))), o.$no_end && (s[h.end] = d ? new Date(d) : this.calculateEndDate({ start_date: s[h.start], duration: this.config.duration_step, task: s })), (o.$no_start || o.$no_end) && this._init_task_timing(s);
  }
  function r(s) {
  ...
  t._init_task_timing = function(s) {
    ...
    if (s) {
      ...
      d.rollup && (l = !0);
      var c = this.getParent(d), u = e(d), h = !0;
      if (l || d.start_date && d.end_date && (u.$no_start || u.$no_end)) {
        ...
        t.resetProjectDates(d), l || _ != d[y].valueOf() || f != d[v].valueOf() || (h = !1), h && !o && this.refreshTask(d.id, !0), u.scheduled_summary && (h = !0);
      }
...
const ia = (t) => {
  Ye() || setTimeout(() => {
    ...
    if (!(typeof 1759992306000 > "u")) {
      var e, i;
      setInterval(() => {
        !t.$destroyed && Date.now() - 1759992306000 > 5184e6 && t.message({ type: "error", text: n, expire: -1, id: "evaluation-warning" });
...
function aa(t) {
  ...
  var i = (function() {
    ...
    J(t) || (this.$root.innerHTML = "", this.$root.gantt = this, Ae(this), this.config.layout.id = "main", this.$layout = this.$ui.createView("layout", this.$root, this.config.layout), this.$layout.attachEvent("onBeforeResize", function() {
      ...
      s.className = "gantt_container_resize_watcher", s.tabIndex = -1, r.config.wai_aria_attributes && (s.setAttribute("role", "none"), s.setAttribute("aria-hidden", !0)), r.env.isSalesforce && (r.config.container_resize_method = "timeout"), r.$root.appendChild(s), s.contentWindow ? fn(r, s.contentWindow) : (r.$root.removeChild(s), fn(r, window));
    }(this));
  }).bind(t);
...
`);
    if (typeof 1759992306000 > "u") return;
    const e = function() {
      var i, a;
      setTimeout(() => {
        Date.now() - 1759992306000 > 7776e6 && window.alert(n), e();
...
function Ba() {
  this.constants = xi, this.version = "9.0.15", this.license = "evaluation", this.templates = {}, this.ext = {}, this.keys = { edit_save: this.constants.KEY_CODES.ENTER, edit_cancel: this.constants.KEY_CODES.ESC };
}
function za(t) {
  ...
  n.plugins = function(l) {
    ...
    return { cache: !0, method: "get", parse: function(d) {
      return typeof d != "string" ? d : (d = d.replace(/^[\s]+/, ""), typeof DOMParser > "u" || bt.isIE ? Y.ActiveXObject !== void 0 && ((c = new Y.ActiveXObject("Microsoft.XMLDOM")).async = "false", c.loadXML(d)) : c = new DOMParser().parseFromString(d, "text/xml"), c);
      var c;
      ...
      if (c.nodeName || (c = c.responseXML || c), bt.isIE) return c.selectNodes(d) || [];
      ...
      return new l.Promise(function(y, v) {
        ...
        h && (b.onreadystatechange = function() {
          if (b.readyState == 4 || g && b.readyState == 3) {
            ...
            setTimeout(function() {
              typeof _ == "function" && _.apply(Y, [{ xmlDoc: b, filePath: c }]), y(b), typeof _ == "function" && (_ = null, b = null);
            }, 0);
          }
        });
  ...
  var r = /* @__PURE__ */ function(l) {
    ...
    return { initTemplates: function() {
      ...
      c("date_scale", !0, void 0, l.config, l.templates), c("date_grid", !0, "grid_date_format", l.config, l.templates), c("task_date", !0, void 0, l.config, l.templates), l.mixin(l.templates, { xml_format: void 0, format_date: f, xml_date: void 0, parse_date: y, progress_text: function(v, b, g) {
        return "";
  ...
  s.registerProvider("global", function() {
    ...
    return s;
  }), O(n, On), n.Promise = Ci, n.env = bt, function(l) {
    var d = Ai.create();
    O(l, d);
    ...
    }), c = {}, l.attachEvent("onBeforeTaskDelete", function(m, p) {
      return c[m] = Me.getSubtreeLinks(l, m), !0;
    }), l.attachEvent("onAfterTaskDelete", function(m, p) {
      c[m] && l.$data.linksStore.silent(function() {
        for (var k in c[m]) l.isLinkExists(k) && l.$data.linksStore.removeItem(k), v(c[m][k]);
        c[m] = null;
      });
    ...
    l.ext || (l.ext = {});
    for (var d = [Ri, Hi, Bi, zi, ji, Fi, Wi, Vi, Ui], c = 0; c < d.length; c++) d[c] && d[c](l);
  }(n), function(l) {
    (function(d) {
      d.getGridColumn = function(c) {
        for (var u = d.config.columns, h = 0; h < u.length; h++) if (u[h].name == c) return u[h];
        return null;
  ...
  var o = new Ta({ en: ga, ar: sa, be: oa, ca: la, cn: da, cs: ca, da: ua, de: ha, el: _a, es: fa, fa: pa, fi: ma, fr: va, he: ka, hr: ya, hu: ba, id: $a, it: xa, jp: wa, kr: Sa, nb: Ea, nl: Ca, no: Da, pl: Aa, pt: Ma, ro: Ia, ru: La, si: Na, sk: Pa, sv: Ra, tr: Ha, ua: Oa });
  return n.i18n = { addLocale: o.addLocale, setLocale: function(l) {
    if (typeof l == "string") {
      var d = o.getLocale(l);
      d || (d = o.getLocale("en")), n.locale = d;
    } else if (l) if (n.locale) for (var c in l) l[c] && typeof l[c] == "object" ? (n.locale[c] || (n.locale[c] = {}), n.mixin(n.locale[c], l[c], !0)) : n.locale[c] = l[c];
    else n.locale = l;
...
const Wa = function(t) {
  ...
  function i(a, r, s, o) {
    ...
    return l.configure && l.configure(d), Fa(d, o), d.$id || (d.$id = s.id || t.uid()), d.$parent || typeof r != "object" || (d.$parent = r), d.$config || (d.$config = s), e[d.$id] && (d.$id = t.uid()), e[d.$id] = d, d;
  }
...
var Ga = function(t) {
  var n = /* @__PURE__ */ function(e) {
    ...
    function s(o, l, d) {
      ...
      typeof l.renderer == "function" ? (c = l.renderer, h = ie) : (c = l.renderer.render, u = l.renderer.update, _ = l.renderer.onrender, l.renderer.isInViewPort ? f = l.renderer.isInViewPort : h = l.renderer.getRectangle, h || h === null || (h = ie));
      var y = l.filter;
      return d && d.setAttribute(e.config.layer_attribute, !0), a[o] = { render_item: function(v, b, g, m, p) {
        if (b = b || d, !y || y(v)) {
          var k = m || r(l), w = p || (k ? k.$getConfig() : null), x = g;
          !x && w && w.smart_rendering && (x = k.getViewPort());
          var $ = null;
          !Wt(e) && (h || f) && x ? (f ? f(v, x, k, w, e) : vn(x, h(v, k, w, e))) && ($ = c.call(e, v, k, w, x)) : $ = c.call(e, v, k, w, x), this.append(v, $, b);
          var S = b.nodeType == 11;
          _ && !S && $ && _.call(e, v, $, k);
        ...
        if (g && g.$getConfig().smart_rendering && !Wt(e) && this.rendered && (h || f)) {
          ...
          for (var T = {}, E = (S = 0, v.length); S < E; S++) {
            ...
            $[C.id] = !1, D && D.parentNode ? (f ? f(C, k, g, m, e) : vn(k, h(C, g, m, e))) ? (u && u.call(e, C, D, g, m, k), this.restore(C, p)) : $[C.id] = !0 : (T[v[S].id] = !0, this.render_item(v[S], p, k, g, m));
          }
  ...
  return { createGroup: function(e, i, a, r) {
    var s = { tempCollection: [], renderers: {}, container: e, filters: [], getLayers: function() {
      ...
      for (let c = 0; c < d.length; c++) {
        ...
        this.renderers[h] = n.getRenderer(h, o, u), r && r(o, t), this.tempCollection.splice(c, 1), c--;
      }
    }, addLayer: function(o) {
      if (o) {
        typeof o == "function" && (o = { renderer: o }), o.filter === void 0 ? o.filter = kn(a || []) : o.filter instanceof Array && (o.filter.push(a), o.filter = kn(o.filter)), o.container || (o.container = document.createElement("div"));
        var l = this;
  ...
  function i(r, s, o) {
    s.$getConfig(), r.getVisibleItems().forEach(function(l) {
      var d = function(c, u, h, _) {
        ...
        var f = yn(_.getTask(c.source), u), y = yn(_.getTask(c.target), u);
        if (!f || !y) return null;
...
function Xn(t, n, e, i, a) {
  var r = e.$gantt.getTask(t.source), s = e.$gantt.getTask(t.target), o = e.getItemTop(r.id), l = e.getItemHeight(r.id), d = e.getItemTop(s.id), c = e.getItemHeight(s.id);
...
var Zn = function(t) {
  ...
  return W(n, t), n.prototype.destructor = function() {
    ...
    for (var c, u = 0; u < i.length; u++) e[(c = i[u]).$config.scroll] ? d(c) : c.shouldHide() ? o.push(c) : c.shouldShow() ? l(c) : c.isVisible() ? r.push(c) : s.push(c);
    var h = {};
    ...
    for (o.forEach(function(f) {
      ...
      l(c);
      for (var _ = 0; _ < r.length; _++) if (r[_] == c) {
    ...
    if (e.length) for (var a = e[0].$parent._xLayout ? "width" : "height", r = e[0].$parent.getNextSibling(e[0].$id) ? 1 : -1, s = i.value, o = i.isGravity, l = 0; l < e.length; l++) {
      var d = e[l].getSize(), c = r > 0 ? e[l].$parent.getNextSibling(e[l].$id) : e[l].$parent.getPrevSibling(e[l].$id);
      ...
      if (o) e[l].$config.gravity = s;
        ...
        e[l].$config.gravity = f * s, c.$config[a] = _ - s, c.$config.gravity = h - f * s;
      } else e[l].$config[a] = s;
  ...
  function n(e, i, a) {
    ...
    function l(d) {
      var c = d.pageX, u = d.pageY;
      return d.touches && (c = d.touches[0].pageX, u = d.touches[0].pageY), { x: c, y: u };
    }
    return o._moveHandler = function(d) {
      o._moveResizer(o._resizer, l(d).x, l(d).y);
    }, o._upHandler = function(d) {
      var c = o._getNewSizes();
      o.callEvent("onResizeEnd", [r, s, c ? c.back : 0, c ? c.front : 0]) !== !1 && o._setSizes(), o._setBackground(!1), o._clearResizer(), o._clearListeneres(), d.touches && (o.$gantt._prevent_touch_scroll = !1);
      ...
      if (this._callStartDNDEvent() !== !1) {
        ...
        }), c || (o._moveHandler(d), o.$domEvents.attach(document, "mousemove", o._moveHandler), o.$domEvents.attach(document, "mouseup", o._upHandler));
      }
  ...
  return W(n, t), n.prototype.init = function() {
    ...
    if (u === -1) {
      if (c = o - a, d = r - Math.abs(a), o - a > this._front.$config.maxWidth) return;
      Math.abs(a) >= r && (a = -Math.abs(r - 2)), r - Math.abs(a) <= s && (a = -Math.abs(r - s));
    } else c = o - Math.abs(a), d = r + a, r + a > this._behind.$config.maxWidth && (a = this._behind.$config.maxWidth - r), Math.abs(a) >= o && (a = o - 2), o - Math.abs(a) <= l && (a = Math.abs(o - l));
    return u === -1 ? (c = o - a, d = r - Math.abs(a)) : (c = o - Math.abs(a), d = r + a), { size: a, newFrontSide: c, newBehindSide: d };
  ...
  return W(e, t), e.prototype.init = function(a) {
    ...
    for (var a, r = 0, s = 0, o = this._isHorizontal(), l = this._getLinkedViews(), d = o ? "scrollWidth" : "scrollHeight", c = o ? "contentX" : "contentY", u = o ? "x" : "y", h = this._getScrollOffset(), _ = 0; _ < l.length; _++) if ((a = l[_]) && a.$content && a.$content.getSize && !a.$config.hidden) {
    ...
    if (this._checkWheelTarget(r)) {
      ...
      var d = bt.isFF, c = d ? a.deltaX : a.wheelDeltaX, u = d ? a.deltaY : a.wheelDelta, h = -20;
      if (d) {
    ...
    if ((h.static_background || h.timeline_placeholder) && document.createElement("canvas").getContext) {
      ...
      var v = function(p) {
        ...
        for (var C in S) {
          ...
          if (!r(A)) {
            var I = l(D, T, p);
            o(A, I), E += "." + d(A) + "{ background-image: url('" + I + "');}";
          }
          $[C] = d(A);
        }
        return E && (function() {
...
var Je = function(t, n, e, i) {
  this.$config = O({}, n || {}), this.$scaleHelper = new Fn(i), this.$gantt = i, this._posFromDateCache = {}, this._timelineDragScroll = null, O(this, Un(this)), _t(this);
};
function ye(t) {
  ...
  return { init: function() {
      ...
      var r = this, s = Qt(function() {
        if (r.$gantt.getState().lightbox) s();
          ...
          if (d && l.$config.name === r.$gantt.config.resource_store) {
            ...
            l._quick_refresh = !0, r.relevantResources.forEach(function(c) {
              l.refresh(c);
            }), l._quick_refresh = !1;
          } else l.refresh();
        }
    ...
    a.$config.fetchTasks && a.silent(function() {
      ...
      for (var l in a.eachItem(function(d) {
        if (d.$role != "task") {
          var c = i.getResourceAssignments(d.id), u = {};
          c.sort(function(h, _) {
...
Je.prototype = { init: function(t) {
  ...
  var c = 0, u = t.count;
  !a.smart_scales || isNaN(n) || isNaN(e) || (c = Bt(t.left, n), u = Bt(t.left, e) + 1), l = t.css || function() {
...
const nr = { init: function(t, n) {
  ...
  r.attachEvent("onBeforeFocus", function(s) {
    ...
    var l = t.locateCell(o.target), d = !!l && t.getEditorConfig(l.columnName), c = t.getState(), u = i.constants.KEY_CODES, h = o.keyCode, _ = !1;
    switch (h) {
      case u.ENTER:
      ...
      default:
        if (t.isVisible()) _ = !0;
          ...
          y.alt || v && r.getCommandHandler(s, "taskCell") || d && !t.isVisible() && (e.startEdit(l.id, l.columnName), _ = !0);
        }
    }
    return !_;
  });
...
function or(t) {
  ...
  return W(r, n), O(r.prototype, { show: function(s, o, l, d) {
...
function lr(t) {
  ...
  return W(e, n), O(e.prototype, { show: function(l, d, c, u) {
    ...
    var h = this.get_value(d, c, u), _ = a(r(l, c.editor, t), c.editor);
...
function hr(t) {
  ...
  var i = { init: ur, createEditors: function(a) {
    ...
    var s = cr(t), o = [], l = [], d = null, c = { _itemId: null, _columnName: null, _editor: null, _editorType: null, _placeholder: null, locateCell: function(u) {
      ...
      var u = this.getState(), h = u.id, _ = u.columnName, f = a.getColumn(_), y = d.getItem(h), v = this.getEditorConfig(_);
      if (v) {
        var b = y[v.map_to];
      ...
      if (this.isVisible() && d.exists(this._itemId) && this.isChanged()) {
        ...
        if (d.exists(u)) {
          ...
          if (this.callEvent("onBeforeSave", [y]) !== !1 && (!this._editor.is_valid || this._editor.is_valid(y.newValue, y.id, a.getColumn(h), this._placeholder))) {
            ...
            v != "auto" ? (_[v] = b, s(_, v, t.config.inline_editors_date_processing), d.updateItem(u)) : this._editor.save(u, a.getColumn(h), this._placeholder), this.callEvent("onSave", [y]);
          }
          this.hide();
        }
      } else this.hide();
...
function It(t, n, e, i, a) {
  ...
  var o = e.posFromDate(t.start_date), l = e.posFromDate(t.end_date), d = Math.min(o, l) - 200, c = Math.max(o, l) + 200;
  return !(d > n.x_end || c < n.x);
}
function be(t) {
  function n(r, s, o) {
    if (t._isAllowedUnscheduledTask(r) || !t._isTaskInTimelineLimits(r)) return;
    var l = s.getItemPosition(r), d = o, c = s.$getTemplates(), u = t.getTaskType(r.type), h = s.getBarHeight(r.id, u == d.types.milestone), _ = 0;
    ...
    s.$config.item_attribute && (b.setAttribute(s.$config.item_attribute, r.id), b.setAttribute(s.$config.bind + "_id", r.id)), d.show_progress && u != d.types.milestone && function(T, E, C, D, A) {
...
<path d="M5.58397 1.52543C5.78189 1.22856 6.21811 1.22856 6.41602 1.52543L10.5475 7.72265C10.769 8.05493 10.5308 8.5 10.1315 8.5L1.86852 8.5C1.46917 8.5 1.23097 8.05493 1.45249 7.72265L5.58397 1.52543Z" fill="var(--dhx-gantt-progress-handle-background)" stroke="var(--dhx-gantt-progress-handle-border)"/>
    ...
    }(r, d, c, _), w && b.appendChild(w), t._waiAria.setTaskBarAttr(r, b);
    var x = t.getState();
...
function gr(t) {
  function n(r, s, o) {
    ...
    k.classList.add("gantt_task_line_actual", "gantt_task_line", "gantt_project"), k.style.cssText = ["position:absolute", "left:" + w.left + "px", "top:16px", "height:8px", "width:" + w.width + "px"].join(";"), b.appendChild(k), d.show_progress && u != d.types.milestone && function(T, E, C, D, A) {
      var I = 1 * T.progress || 0;
      C = Math.max(C - 2, 0);
      var M = document.createElement("div"), L = Math.round(C * I);
    ...
    $ && m.appendChild($), $ = function(T, E, C, D) {
      var A = "gantt_right " + i(!!E.rtl, T), I = null;
      return D && (I = { type: "marginLeft", value: D }), e(T, C.rightside_text, A, I);
    }(r, d, c, _), $ && m.appendChild($), t._waiAria.setTaskBarAttr(r, b);
    var S = t.getState();
...
function mr(t) {
  var n = { current_pos: null, dirs: { left: "left", right: "right", up: "up", down: "down" }, path: [], clear: function() {
    ...
    var l = this.get_endpoint(a, r, s, o), d = t.config, c = l.e_y - l.y, u = l.e_x - l.x, h = n.dirs, _ = r.getItemHeight(a.source);
    ...
    var l = r.$getConfig(), d = this.get_line_type(a, l), c = d.from_start, u = d.to_start, h = i(s, r, l), _ = i(o, r, l);
  ...
  function i(a, r, s) {
    ...
    let l = ne(t, r, a), d = l.maxHeight, c = l.splitChild;
  ...
  return { render: function(a, r, s) {
    ...
    var d = e.get_endpoint(a, r, o, l), c = d.e_y - d.y;
...
function ti(t) {
  ...
  return t.$data.tasksStore.attachEvent("onStoreUpdated", function() {
    ...
    return o = n[s] ? n[s] : n[s] = function(l, d, c, u) {
      ...
      let g, m, p, k, w;
      const x = u.$getConfig();
      for (let $ = 0; $ < c.trace_x.length; $++) g = new Date(c.trace_x[$]), m = t.date.add(g, v, y), w = f[g.valueOf()] || {}, p = w.tasks || [], k = w.assignments || [], p.length || x.resource_render_empty_cells ? b.push({ start_date: g, end_date: m, tasks: p, assignments: k }) : b.push(null);
      return b;
    }(e, i, a, r), o;
  };
}
...
function br(t) {
  ...
  function o(l, d, c, u, h, _, f) {
    ...
    if (y || v) {
      ...
      return m.className = ["gantt_histogram_cell", y].join(" "), m.setAttribute(f.$config.item_attribute, l.id), m.style.cssText = ["left:" + d.left + "px", "width:" + d.width + "px", "height:" + g + "px", "line-height:" + g + "px", "top:" + (d.top + 1) + "px"].join(";"), v && (v = "<div class='gantt_histogram_label'>" + v + "</div>"), b && (v = "<div class='gantt_histogram_fill' style='height:" + 100 * Math.min(b / c || 0, 1) + "%;'></div>" + v), v && (m.innerHTML = v), m;
    }
    return null;
  }
  return { render: function(l, d, c, u) {
    var h = d.$getTemplates(), _ = d.getScale(), f = n(l, c.resource_property, _, d), y = [], v = {}, b = l.capacity || d.$config.capacity || 24;
    ...
    for (var g = !!u, m = Ct(_, u), p = m.start; p <= m.end; p++) {
      ...
      if (k && (!g || Vt(p, _, u, t))) {
        ...
        var x = d.getItemPosition(l, k.start_date, k.end_date), $ = o(l, x, b, 0, h, k, d);
        $ && (y.push($), e[l.id][p] = $);
      }
    }
    var S = null;
    ...
    var _ = c.$getTemplates(), f = c.getScale(), y = n(l, u.resource_property, f, c), v = l.capacity || c.$config.capacity || 24, b = {}, g = !!h, m = Ct(f, h), p = {};
...
function Xe(t, n, e, i, a, r) {
  ...
  const l = o(t);
  let d = !1;
  return l && (s.start_date = t[r.start_date], s.end_date = t[r.end_date]), t.render == "split" && a.eachTask(function(c) {
    o(c) && (d = !0, s.start_date = s.start_date || c[r.start_date], s.end_date = s.end_date || c[r.end_date], s.start_date < c[r.start_date] && (s.start_date = c[r.start_date]), s.end_date > c[r.end_date] && (s.end_date = c[r.end_date]));
  }), !(!l && !d) && It(s, n, e);
}
...
function xr(t) {
  ...
  function e(i, a, r) {
    ...
    let { height: d, marginTop: c } = Vn(t, a, l, 30, i, r), u = d, h = 0;
    switch (s) {
      case "snet":
      case "fnet":
      case "mso":
    ...
    switch (i.type === t.config.types.milestone && (c -= 1), o.style.height = d + "px", o.style.width = u + "px", o.style.left = l.left + "px", o.style.top = l.top + "px", o.style.marginLeft = h + "px", o.style.marginTop = c + "px", o.className = "gantt_constraint_marker gantt_constraint_marker_" + s, s) {
      case "snet":
      case "snlt":
      case "fnet":
      case "fnlt":
...
function Sr(t, n, e, i, a) {
  ...
  return t.type == a.config.types.milestone && (s.end_date = s.start_date), t.baselines && (r = bn(t, n, e, i, a, s)), pt(t) && a.eachTask(function(o) {
    r || o.baselines && o.baselines.length && (o.type == a.config.types.milestone && (s.end_date = s.start_date), bn(o, n, e, i, a, s) && (r = !0));
  }, t.id), r;
}
function bn(t, n, e, i, a, r) {
  for (var s = 0; s < t.baselines.length; s++)
    if (Xe({ id: t.id, parent: t.parent, start_date: t.baselines[s].start_date, end_date: t.baselines[s].end_date }, n, e, 0, a, r)) return !0;
}
const Tr = { init: function(t, n) {
  ...
  if (n.$config.bind && t.getDatastore(n.$config.bind)) {
    ...
    t.defined(n.$getConfig().dnd_sensitivity) && (i.config.sensitivity = n.$getConfig().dnd_sensitivity), i.attachEvent("onBeforeDragStart", t.bind(function(o, l) {
      ...
      var l = K(n.$grid_data), d = l.x + n.$grid.scrollLeft, c = o.pos.y - 10, u = n.getItemHeight(i.config.id);
      c < l.y && (c = l.y);
      ...
      var l = K(n.$grid_data), d = n.$state.scrollTop || 0, c = t.$grid_data.getBoundingClientRect().height + d, u = o.pageY - l.y + d;
...
const Sn = { removeLineHighlight: function(t) {
  ...
  var i = function(r, s) {
    var o = K(s.$grid_data), l = dt(r, s.$grid_data), d = o.x + s.$grid.scrollLeft, c = l.y - 10, u = s.getItemHeight(r.targetId);
    c < o.y && (c = o.y);
  ...
  a || ((a = document.createElement("div")).className = "gantt_drag_marker gantt_grid_dnd_marker", a.innerHTML = "<div class='gantt_grid_dnd_marker_line'></div>", a.style.pointerEvents = "none"), t.child ? function(r, s, o) {
    var l = r.targetParent, d = wn({ x: 0, y: o.getItemTop(l) }, o), c = o.$grid_data.getBoundingClientRect().bottom + window.scrollY;
  ...
  function s(o) {
    ...
    }(o), c = null, u = n.$config.rowStore, h = !n.$getConfig().order_branch_free, _ = dt(o, n.$grid_data).y;
    return document.doctype || (_ += window.scrollY), d !== u.$getRootId() && (c = (_ - n.getItemTop(d)) / n.getItemHeight(d)), h ? (l = xn(i.config.id, d, c, _, u, i.config.level)) && l.targetParent && r(l.targetParent) && (d = u.getPrevSibling(l.targetParent), l = xn(i.config.id, d, c, _, u, i.config.level)) : l = function(f, y, v, b, g) {
      var m;
    ...
    return t = function(i, a) {
      ...
      return { drag: null, dragMultiple: {}, _events: { before_start: {}, before_finish: {}, after_finish: {} }, _handlers: {}, init: function() {
        ...
        for (var d in s) {
          ...
          if (!u.unscheduled) {
            var h = this._drag_task_coords(u, c), _ = a.posFromDate(new Date(a.getState().min_date)), f = a.posFromDate(new Date(a.getState().max_date));
            if (h.end + o > f) {
              var y = f - h.end;
              (y < l || l === void 0) && (l = y);
            } else if (h.start + o < _) {
        ...
        this._handlers[l].apply(this, [f, s, d, u]), a.mixin(h, f, !0), a.callEvent("onTaskDrag", [h.id, l, f, _, c]), a.mixin(h, f, !0), a.refreshTask(o);
...
var Ar = function(t, n) {
  ...
  var u = "gantt_link_point", h = "gantt_link_control", _ = new c(t.$task_bars, { sensitivity: 0, updates_per_second: 60, mousemoveContainer: n.$root, selector: "." + u, preventDefault: !0 });
  function f(m, p) {
  ...
  return { getVerticalScrollbar: function() {
    ...
    if (i.resizer) {
      ...
      s.attachEvent("onResizeStart", function(o, l) {
        ...
        var u = r ? o : l, h = r ? d : c, _ = t.$ui.getView("grid"), f = _ ? _.$parent : null;
...
const Nr = { init: function(t) {
  ...
  var i = function(r) {
    ...
    return { getDataRender: function(o) {
      ...
      var l = o.name, d = o.defaultContainer, c = o.defaultContainerSibling, u = s.createGroup(d, c, function(h, _) {
  ...
  return t.ext.inlineEditors = a, t.ext._inlineEditors = a, a.init(t), { factory: e, mouseEvents: Ua.init(t), layersApi: i.init(), render: { gridLine: function() {
    return /* @__PURE__ */ function(r) {
      ...
      }, update: null, getRectangle: ie, isInViewPort: vr, getVisibleRange: Q, onrender: function(s, o, l) {
    ...
    return /* @__PURE__ */ function(r) {
      ...
      return { render: function(_, f, y, v) {
        ...
        var g = y.getScale(), m = g.count, p = c(y), k = u(y);
      ...
      return { render: function(u, h, _, f) {
        if (u.rollup !== !1 && u.$rollup && u.$rollup.length) {
          ...
          return f && (f.y = 0, f.y_end = r.$task_bg.scrollHeight), u.$rollup.forEach(function(b) {
            ...
            if (!l(g, f, h, _)) return;
            const m = d(u, g, h, v);
            m ? (o[c(g.id, u.id)] = m, y.appendChild(m)) : o[c(g.id, u.id)] = !1;
          }), y;
        }
        return !1;
        ...
        y.y = 0, y.y_end = r.$task_bg.scrollHeight, u.$rollup.forEach(function(g) {
          const m = r.getTask(g), p = c(m.id, u.id);
          let k = l(m, y, _, f);
          if (k !== !!o[p]) if (k) {
            const w = d(u, m, _, b);
            o[p] = w || !1;
      ...
      return { render: function(h, _, f, y) {
        if (u(h, f)) {
          ...
          return r.hasChild(h.id) && r.eachTask(function(m) {
            if (!l(m, y, _, f)) return;
            const p = d(h, m, _, b, g);
            p ? (o[c(m.id, h.id)] = p, v.appendChild(p)) : o[c(m.id, h.id)] = !1;
          }, h.id), v;
        }
        return !1;
    ...
    return /* @__PURE__ */ function(r) {
      function s(o, l, d) {
        const c = document.createElement("div"), u = r.getTaskPosition(o, o.deadline, o.deadline), { height: h, marginTop: _ } = Vn(r, l, u, 20, o, d);
        let f = h;
        return r.config.rtl && (u.left += f), c.style.left = u.left - f + "px", c.style.top = u.top + "px", c.style.marginTop = _ + "px", c.style.width = f + "px", c.style.height = h + "px", c.style.fontSize = h + "px", c.className = "gantt_task_deadline", c.setAttribute("data-task-id", o.id), c;
      }
      return { render: function(o, l, d, c) {
    ...
    return /* @__PURE__ */ function(r) {
      function s(o, l, d, c, u) {
        ...
        let g = ne(r, c, o, y.rowHeight).maxHeight, m = y.top + 1 + b, p = c.getBarHeight(o.id, o.type);
        ...
        switch (r.config.baselines.render_mode) {
          ...
          case "individualRow":
            ...
            break;
          default:
            $ = 1, u ? (g = ne(r, c, o).maxHeight, b ? g >= v ? $ = (g - p) / 2 - 1 - b : (p = _n(g), m = y.top, $ = Math.abs(p - g) / 2, b = 0) : (g > p && ($ = (g - p) / 2 - 1), $ -= b), o.bar_height || ($ -= 1)) : (o.bar_height && y.rowHeight >= o.bar_height && ($ = (y.rowHeight - o.bar_height) / 2 - 1), $ += b, o.bar_height || ($ += 2), f && ($ += 1));
        }
        let S = y.top + g + 1 - b;
    ...
    return function(r) {
      ...
      function l(c, u, h, _, f) {
        ...
        if (y || v) {
          var g = f.getItemPosition(c, u.start_date, u.end_date), m = document.createElement("div");
          return m.setAttribute(f.$config.item_attribute, c.id), m.className = ["gantt_resource_marker", y].join(" "), m.style.cssText = ["left:" + g.left + "px", "width:" + g.width + "px", "height:" + b + "px", "line-height:" + b + "px", "top:" + g.top + "px"].join(";"), v && (m.innerHTML = v), m;
        }
        return null;
      }
      function d(c, u) {
      ...
      return { render: function(c, u, h, _) {
        var f = u.$getTemplates(), y = u.getScale(), v = s(c, h.resource_property, u.getScale(), u), b = !!_, g = [];
        o[c.id] = {};
        ...
        var y = h.$getTemplates(), v = h.getScale(), b = s(c, _.resource_property, h.getScale(), h), g = Ct(v, f), m = {};
        if (o && o[c.id]) for (var p in o[c.id]) m[p] = p;
        for (var k = g.start; k <= g.end; k++) {
          var w = b[k];
          if (m[k] = !1, w) if (Vt(k, v, f, r)) if (o[c.id] && o[c.id][k]) o[c.id] && o[c.id][k] && !o[c.id][k].parentNode && u.appendChild(o[c.id][k]);
          else {
            var x = l(c, w, y, 0, h);
      ...
      if (!o(p) && c) {
        ...
        if (!t._prevent_touch_scroll) {
          if (w && h) {
            ...
            if (!u && (Math.abs(x) > 5 || Math.abs($) > 5) && (u = !0, d = 0, l = v ? e(v) : t.getScrollState()), u) {
              var S, T = l.x + x, E = l.y + $;
              if (v ? (function(C, D, A) {
...
function jr(t) {
  ...
  function a(l, d, c, u) {
    var h, _ = "";
    if (l) return h = [{ key: "data-item-id", value: l.key }, { key: "data-assignment-id", value: u || "" }, { key: "class", value: "gantt_resource_amount_input" }], c && h.push({ key: "disabled", value: "disabled" }), l.options ? _ += ae.getHtmlSelect(l.options, h, d) : (h[h.length] = { key: "value", value: d || "" }, _ += ae.getHtmlInput(h)), _;
  }
  function r(l) {
  ...
  return t.attachEvent("onAfterLightbox", function() {
    ...
    var c = t.locale.labels.resources_filter_placeholder || l.filter_placeholder || "type to filter", u = t.locale.labels.resources_filter_label || "hide empty";
    return d = "<div" + (isNaN(l.height) ? "" : " style='height: " + l.height + "px;'") + " class='gantt_section_" + l.name + "'>", d += "<div class='gantt_cal_ltext gantt_resources_filter'><input type='text' class='gantt_resources_filter_input' placeholder='" + c + "'> <label><input class='switch_unsetted' type='checkbox'><span class='matherial_checkbox_icon'></span>" + u + "</label></div>", d += "<div class='gantt_cal_ltext gantt_resources' data-name='" + l.name + "'></div>", d += "</div>";
    ...
    (function(y, v) {
      ...
      var w, x, $;
    }(l, c, u, this), ht(u.options, function(y, v) {
    ...
    for (var u = s(c), h = [], _ = r(!0), f = r(!1), y = o(c), v = t.copy(e.resourcesValues[c.id]) || {}, b = u.querySelectorAll(_), g = u.querySelectorAll(f), m = 0; m < g.length; m++) delete v[g[m].getAttribute("data-item-id")];
...
<div class="gantt_cal_ltitle_controls">
  ...
  }, template: new n(), textarea: new e(), select: new a(), time: new i(), duration: new o(), parent: new l(), radio: new s(), checkbox: new r(), resources: new d(), constraint: new c(), baselines: new h(), typeselect: new u() }, t._is_lightbox_timepicker = function() {
...
function Wr(t) {
  if (!bt.isNode) {
    ...
    var n = Ve();
    t.event = n.attach, t.eventRemove = n.detach, t._eventRemoveAll = n.detachAll, t._createDomEventScope = n.extend, O(t, ja(t));
    var e = Nr.init(t);
    t.$ui = e.factory, t.$ui.layers = e.render, t.$mouseEvents = e.mouseEvents, t.$services.setService("mouseEvents", function() {
      ...
      for (var d in i._waiAria = { getAttributeString: function(c) {
        ...
        return c.editor && !i.isReadonly(h) || (_["aria-readonly"] = !0), this.getAttributeString(_);
...
Y.gantt = Ur, Y.Gantt = Be, Be.plugin((t) => {
  Ye() || setTimeout(() => {
    ...
    if (!(typeof 1759992306000 > "u")) {
      var e, i;
      setInterval(() => {
        !t.$destroyed && Date.now() - 1759992306000 > 27648e5 && t.message({ type: "error", text: n, expire: -1, id: "evaluation-warning" });
