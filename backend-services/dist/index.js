...
const userRoutes_1 = __importDefault(require("../../backend-modifications/userRoutes"));
const authRoutes_1 = __importDefault(require("../../backend-modifications/authRoutes"));
